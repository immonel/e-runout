...
F 2 "Package_SO:TSSOP-20_4.4x6.5mm_P0.65mm" H 8050 4650 50  0001 C CNN
...
F 2 "Connector_Coaxial:SMA_Amphenol_132134-14_Vertical" H 1450 10750 50  0001 C CNN
F 3 " ~" H 1450 10750 50  0001 C CNN
	1    1450 10750
	-1   0    0    1   
$EndComp
Text Label 2750 12650 2    50   ~ 0
ADC_INGND
Text Label 2750 12450 2    50   ~ 0
ADC_IN5V
Wire Wire Line
	3150 12050 3600 12050
Wire Wire Line
	3800 12050 4200 12050
Text Label 4350 12050 0    50   ~ 0
HV_REF
$Comp
L Analog_ADC:MCP3301 U7
U 1 1 61966194
P 3700 12550
F 0 "U7" H 3650 11969 50  0000 C CNN
F 1 "MCP3301" H 3650 12060 50  0000 C CNN
F 2 "Package_SO:MSOP-8_3x3mm_P0.65mm" H 4500 12450 50  0001 C CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/21700D.pdf" H 4500 12450 50  0001 C CNN
	1    3700 12550
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	17650 7600 17400 7600
Text Label 17650 7600 0    50   ~ 0
ADC_REF
...
U 1 1 6198A32B
P 3600 13150
F 0 "#PWR017" H 3600 12900 50  0001 C CNN
F 1 "GND" H 3605 12977 50  0000 C CNN
F 2 "" H 3600 13150 50  0001 C CNN
F 3 "" H 3600 13150 50  0001 C CNN
	1    3600 13150
	1    0    0    -1  
$EndComp
Text Label 4600 12650 0    50   ~ 0
ADC_CS_HV
Text Label 4600 12550 0    50   ~ 0
ADC_MISO_HV
Text Label 4600 12450 0    50   ~ 0
ADC_CLK_HV
Wire Wire Line
	4600 12450 4200 12450
Wire Wire Line
	4200 12550 4600 12550
Wire Wire Line
	4200 12650 4600 12650
Text Label 3150 12050 2    50   ~ 0
ADC_REF
Wire Wire Line
	2750 12450 3100 12450
Wire Wire Line
	2750 12650 3100 12650
$Comp
L power:GND #PWR015
U 1 1 619A1D4F
P 16200 8200
F 0 "#PWR015" H 16200 7950 50  0001 C CNN
F 1 "GND" H 16205 8027 50  0000 C CNN
...
F 2 "Package_SO:TSSOP-20_4.4x6.5mm_P0.65mm" H 7250 9800 50  0001 C CNN
...
F 2 "Package_SO:SOIC-16_4.55x10.3mm_P1.27mm" H 5200 2600 50  0001 L BNN
...
F 2 "Package_SO:SOIC-16_4.55x10.3mm_P1.27mm" H 5000 7200 50  0001 L BNN
...
U 1 1 61B01F53
P 8350 7300
F 0 "#PWR0103" H 8350 7050 50  0001 C CNN
...
U 1 1 61D47DFC
P 15550 9500
F 0 "#PWR01" H 15550 9350 50  0001 C CNN
F 1 "+5V" H 15565 9673 50  0000 C CNN
...
$EndComp
$Comp
L Regulator_Linear:TPS793475-EP U5
U 1 1 61D5BA08
P 15950 7700
F 0 "U5" H 15950 8042 50  0000 C CNN
F 1 "TPS793475-EP" H 15950 7951 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-5" H 15950 8025 50  0001 C CIN
F 3 "http://www.ti.com/lit/ds/symlink/tps79333-ep.pdf" H 15950 7750 50  0001 C CNN
	1    15950 7700
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 61D80623
P 16850 8400
F 0 "#PWR06" H 16850 8150 50  0001 C CNN
F 1 "GND" H 16855 8227 50  0000 C CNN
...
U 1 1 61D89473
P 16850 8050
F 0 "C2" H 16965 8096 50  0000 L CNN
F 1 "C" H 16965 8005 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 16888 7900 50  0001 C CNN
F 3 "~" H 16850 8050 50  0001 C CNN
	1    16850 8050
	1    0    0    -1  
$EndComp
Wire Wire Line
	16850 8400 16850 8200
Wire Wire Line
	16850 7900 16850 7700
Wire Wire Line
	16850 7700 16250 7700
$Comp
L power:GND #PWR07
U 1 1 61DAD5E6
P 17400 8200
F 0 "#PWR07" H 17400 7950 50  0001 C CNN
F 1 "GND" H 17405 8027 50  0000 C CNN
F 2 "" H 17400 8200 50  0001 C CNN
...
U 1 1 61DAD5EC
P 17400 7850
F 0 "C3" H 17515 7896 50  0000 L CNN
F 1 "C" H 17515 7805 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 17438 7700 50  0001 C CNN
F 3 "~" H 17400 7850 50  0001 C CNN
	1    17400 7850
	1    0    0    -1  
$EndComp
Wire Wire Line
	17400 8200 17400 8000
Wire Wire Line
	17400 7600 17400 7700
Wire Wire Line
	16250 7600 17400 7600
$Comp
L power:GND #PWR02
U 1 1 61DC0482
P 14850 8300
F 0 "#PWR02" H 14850 8050 50  0001 C CNN
...
U 1 1 61DC0488
P 14850 7950
F 0 "C1" H 14965 7996 50  0000 L CNN
F 1 "C" H 14965 7905 50  0000 L CNN
...
$EndComp
Wire Wire Line
	14850 8300 14850 8100
$Comp
L power:GND #PWR04
U 1 1 61DDC1C0
P 15300 8200
F 0 "#PWR04" H 15300 7950 50  0001 C CNN
...
$EndComp
Wire Wire Line
	15650 7700 15300 7700
Wire Wire Line
	15300 7700 15300 8200
Wire Wire Line
	15650 7600 14950 7600
Wire Wire Line
	14850 7600 14850 7800
Text Label 14600 7400 2    50   ~ 0
HV_REF
Wire Wire Line
	14600 7400 14950 7400
Wire Wire Line
	14950 7400 14950 7600
Connection ~ 14950 7600
Wire Wire Line
	14950 7600 14850 7600
Connection ~ 17400 7600
$Comp
L Device:C C4
U 1 1 61E50296
P 5400 11950
F 0 "C4" H 5515 11996 50  0000 L CNN
F 1 "C" H 5515 11905 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric" H 5438 11800 50  0001 C CNN
...
U 1 1 61E68AD6
P 5400 12200
F 0 "#PWR08" H 5400 11950 50  0001 C CNN
F 1 "GND" H 5405 12027 50  0000 C CNN
...
Wire Wire Line
	5400 11800 4200 11800
Wire Wire Line
	4200 11800 4200 12050
$Comp
L power:PWR_FLAG #FLG0101
U 1 1 61EA7029
P 17150 9450
F 0 "#FLG0101" H 17150 9525 50  0001 C CNN
F 1 "PWR_FLAG" H 17150 9623 50  0000 C CNN
...
U 1 1 61EB30FE
P 17150 9600
F 0 "#PWR0108" H 17150 9350 50  0001 C CNN
F 1 "GND" H 17155 9427 50  0000 C CNN
F 2 "" H 17150 9600 50  0001 C CNN
F 3 "" H 17150 9600 50  0001 C CNN
	1    17150 9600
	1    0    0    -1  
$EndComp
Wire Wire Line
	17150 9450 17150 9600
$Comp
L power:+3.3V #PWR0105
U 1 1 61EC6E94
P 16100 9500
F 0 "#PWR0105" H 16100 9350 50  0001 C CNN
F 1 "+3.3V" H 16115 9673 50  0000 C CNN
...
LV_REF
Wire Wire Line
	16400 9500 16100 9500
Wire Wire Line
	11600 9300 11950 9300
Text Label 15350 9500 2    50   ~ 0
HV_REF
Wire Wire Line
